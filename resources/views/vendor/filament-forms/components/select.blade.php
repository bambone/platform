@php
    ...
    $selectControlAriaLabelledby = (! $isNative) && (filled($getLabel()) || $field->hasInlineLabel())
        ? "{$id}-label"
        : null;
@endphp
            ...
            <div
                ...
                {{
                    $attributes
                        ...
                        ->merge(
                            filled($selectControlAriaLabelledby)
                                ? ['aria-labelledby' => $selectControlAriaLabelledby]
                                : [],
                            escape: false,
                        )
