...
>
    <input
        id="fi-ta-all-selectable-count-{{ $this->getId() }}"
        name="_fi_ta_all_selectable_records_count"
        type="hidden"
                                ...
                                <div class="fi-ta-content-header">
                                    @if ($isSelectionEnabled && ($maxSelectableRecords !== 1) && (! $isReordering) && (! $selectsGroupsOnly))
                                        <input
                                            ...
                                            id="fi-ta-bulk-page-{{ $this->getId() }}-content-header"
                                            name="fi_ta_bulk_select_page"
                                            type="checkbox"
                                            @if ($isSelectionDisabled)
                                                disabled
                                        ...
                                        >
                                            @if ($isSelectionEnabled && ($maxSelectableRecords !== 1))
                                                <input
                                                    ...
                                                    id="fi-ta-bulk-group-{{ $this->getId() }}-{{ md5((string) $recordGroupKey) }}-{{ $page }}"
                                                    name="fi_ta_bulk_select_group"
                                                    type="checkbox"
                                    ...
                                    >
                                        ...
                                        @elseif ($isSelectionEnabled && $isRecordSelectable($record))
                                            <input
                                                ...
                                                id="fi-ta-record-{{ $this->getId() }}-{{ md5((string) $recordKey) }}"
                                                name="fi_ta_record_selection"
                                                type="checkbox"
                                                @if ($isSelectionDisabled)
                                                    disabled
                                    ...
                                    <tr class="fi-ta-table-stacked-header-row">
                                        ...
                                        >
                                            ...
                                            @if ($isSelectionEnabled && ($maxSelectableRecords !== 1) && (! $selectsGroupsOnly))
                                                <input
                                                    aria-label="{{ __('filament-tables::table.fields.bulk_select_page.label') }}"
                                                    id="fi-ta-bulk-page-{{ $this->getId() }}-stacked-header"
                                                    name="fi_ta_bulk_select_page"
                                                    type="checkbox"
                                                    @if ($isSelectionDisabled)
                                                        disabled
                                            ...
                                            @if ($isSelectionEnabled && $recordCheckboxPosition === RecordCheckboxPosition::BeforeCells)
                                                ...
                                                >
                                                    @if (($maxSelectableRecords !== 1) && (! $selectsGroupsOnly))
                                                        <input
                                                            aria-label="{{ __('filament-tables::table.fields.bulk_select_page.label') }}"
                                                            id="fi-ta-bulk-page-{{ $this->getId() }}-th-before-cells"
                                                            name="fi_ta_bulk_select_page"
                                                            type="checkbox"
                                                            @if ($isSelectionDisabled)
                                                                disabled
                                        ...
                                        @if ($isSelectionEnabled && $recordCheckboxPosition === RecordCheckboxPosition::AfterCells)
                                            ...
                                            >
                                                @if (($maxSelectableRecords !== 1) && (! $selectsGroupsOnly))
                                                    <input
                                                        aria-label="{{ __('filament-tables::table.fields.bulk_select_page.label') }}"
                                                        id="fi-ta-bulk-page-{{ $this->getId() }}-th-after-cells"
                                                        name="fi_ta_bulk_select_page"
                                                        type="checkbox"
                                                        @if ($isSelectionDisabled)
                                                            disabled
                                                        ...
                                                        @if ($isSelectionEnabled && $recordCheckboxPosition === RecordCheckboxPosition::BeforeCells)
                                                            ...
                                                            >
                                                                @if ($maxSelectableRecords !== 1)
                                                                    <input
                                                                        aria-label="{{ __('filament-tables::table.fields.bulk_select_group.label', ['title' => $recordGroupTitle]) }}"
                                                                        id="fi-ta-bulk-group-{{ $this->getId() }}-{{ md5((string) $recordGroupKey) }}-{{ $page }}-bc"
                                                                        name="fi_ta_bulk_select_group"
                                                                        type="checkbox"
                                                                        data-group-selectable-record-keys="{{ json_encode($this->getGroupedSelectableTableRecordKeys($recordGroupKey)) }}"
                                                                        @if ($isSelectionDisabled)
                                                        ...
                                                        @if ($isSelectionEnabled && $recordCheckboxPosition === RecordCheckboxPosition::AfterCells)
                                                            ...
                                                            >
                                                                @if ($maxSelectableRecords !== 1)
                                                                    <input
                                                                        aria-label="{{ __('filament-tables::table.fields.bulk_select_group.label', ['title' => $recordGroupTitle]) }}"
                                                                        id="fi-ta-bulk-group-{{ $this->getId() }}-{{ md5((string) $recordGroupKey) }}-{{ $page }}-ac"
                                                                        name="fi_ta_bulk_select_group"
                                                                        type="checkbox"
                                                                        data-group-selectable-record-keys="{{ json_encode($this->getGroupedSelectableTableRecordKeys($recordGroupKey)) }}"
                                                                        @if ($isSelectionDisabled)
