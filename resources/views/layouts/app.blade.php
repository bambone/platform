...
<body class="antialiased bg-obsidian text-silver selection:bg-moto-amber selection:text-white">
    ...
    <!-- Mobile Messengers (Floating above Sticky CTA) -->
    <div class="fixed right-4 bottom-[calc(88px+env(safe-area-inset-bottom))] z-40 flex flex-col gap-3 sm:hidden">
        <a href="https://wa.me/79130608689" target="_blank" class="w-12 h-12 bg-[#25D366] text-white flex items-center justify-center rounded-full shadow-lg active:scale-[0.98] transition-transform">
        ...
        <a href="https://t.me/motolevins" target="_blank" class="w-12 h-12 bg-[#0088cc] text-white flex items-center justify-center rounded-full shadow-lg active:scale-[0.98] transition-transform">
