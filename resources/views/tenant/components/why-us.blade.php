...
<section class="relative z-10 border-y border-white/[0.02] bg-[#0c0c0e] py-16 sm:py-20 lg:py-28">
    <div class="mx-auto max-w-7xl px-3 sm:px-4 md:px-8">
        ...
        <div class="grid grid-cols-1 gap-5 sm:gap-6 md:grid-cols-2 md:gap-6 lg:gap-8">
            <!-- Block 1 -->
            <div class="group flex flex-col items-start gap-5 rounded-2xl border border-white/5 bg-carbon p-5 transition-colors hover:border-white/10 sm:flex-row sm:gap-6 sm:p-6 md:p-8">
