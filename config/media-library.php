...
use App\Support\MediaLibrary\TenantAwarePathGenerator;
...
return [
     ...
     *
     * Spatie stores conversions on the same disk as originals unless a collection
     * overrides conversionsDiskName — so MEDIA_DISK=r2-public keeps originals and
     * conversions together (URLs via disk URL / CDN, not local /storage symlink).
     */
