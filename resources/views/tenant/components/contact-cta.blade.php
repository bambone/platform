...
<div x-data="{ videoPlaying: false }"
    ...
    <a href="https://wa.me/{{ $contacts['whatsapp'] }}" target="_blank"
       class="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-[#25D366]/30 sm:h-14 sm:w-14 touch-manipulation" aria-label="WhatsApp">
    ...
    <a href="https://t.me/{{ $contacts['telegram'] }}" target="_blank"
       class="flex h-12 w-12 items-center justify-center rounded-full bg-[#0088cc] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-[#0088cc]/30 sm:h-14 sm:w-14 touch-manipulation" aria-label="Telegram">
        <svg class="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
